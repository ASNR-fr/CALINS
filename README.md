...
5. **Ensure all tests pass** by running `pytest ./tests/test_unit.py`
...
@article{petillon,
  ...
  AUTHOR = {Petillon, Barth{\'e}l{\'e}mi and Peron, Arthur and Vuiart, Romain and Jaiswal, Vaibhav and Brovchenko, Mariya},
